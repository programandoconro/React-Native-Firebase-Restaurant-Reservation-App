...
var _isInstalled2 = _interopRequireDefault(require("../../pods/isInstalled"));

var _unregisterNativeModule = _interopRequireDefault(require("../unregisterNativeModule"));

var _unregisterNativeModule2 = _interopRequireDefault(require("../../pods/unregisterNativeModule"));
...
function unregisterNativeModule(name, dependencyConfig, projectConfig, otherDependencies) {
  ...
  if (isIosInstalled) {
    const iOSDependencies = (0, _lodash().compact)(otherDependencies.map(d => d.config.ios));
